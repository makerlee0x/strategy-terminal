...
module.exports = async function handler(req, res) {
  ...
  if (!isAddress(originCurrency) && originCurrency !== NATIVE_ETH) {
    sendJson(res, 400, { ok: false, error: "invalid_input" }, origin);
    return;
  }
  ...
  sendJson(res, 200, { ok: true, quote }, origin);
};
